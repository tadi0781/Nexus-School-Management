...
# Configuration
CSV_FILE_PATH = "static/csv/grade9_students.csv"
            ...
            with open(CSV_FILE_PATH, mode='r', encoding='utf-8') as csvfile:
                ...
                for row_num, row in enumerate(reader, 1):
                    ...
                    if unique_code and unique_code != "0":
                        ...
                        # Fetch existing codes for this row
                    ...
                    user = db.session.query(User).filter_by(username=target_code).first()
                    secret_code = db.session.query(SecretCode).filter_by(code=target_code).first()

                    if user:
                        # User exists, update secret code if necessary
