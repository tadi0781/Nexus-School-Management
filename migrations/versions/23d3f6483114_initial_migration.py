...
Revision ID: 23d3f6483114
Revises: 
Create Date: 2025-06-04 20:22:47.760491
...
def upgrade():
    ...
    op.create_index(op.f('ix_social_groups_name'), 'social_groups', ['name'], unique=True)
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('secret_code_id', sa.Integer(), nullable=True),
    sa.Column('subject', sa.String(length=100), nullable=False),
    sa.Column('salary', sa.Float(), nullable=True),
    sa.Column('grade', sa.String(length=10), nullable=True),
    sa.Column('section', sa.String(length=10), nullable=True),
    sa.ForeignKeyConstraint(['secret_code_id'], ['secret_code.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'secret_code_id', 'grade', 'section', name='uq_teacher_profile_assignment')
    )
    op.create_index('idx_teacher_profile_grade_section', 'teacher_profile', ['grade', 'section'], unique=False)
    op.create_index('idx_teacher_profile_secret_code', 'teacher_profile', ['secret_code_id'], unique=False)
    op.create_index('idx_teacher_profile_user', 'teacher_profile', ['user_id'], unique=False)
    op.create_index(op.f('ix_teacher_profile_secret_code_id'), 'teacher_profile', ['secret_code_id'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_teacher_profile_secret_code_id'), table_name='teacher_profile')
    op.drop_index('idx_teacher_profile_user', table_name='teacher_profile')
    op.drop_index('idx_teacher_profile_secret_code', table_name='teacher_profile')
    op.drop_index('idx_teacher_profile_grade_section', table_name='teacher_profile')
